...
<head>
    ...
    <style>
        ...
        body {
            ...
            align-items: center;
            background: #f0f2f5;
            /* optional, latar belakang */
        }

        main {
            width: 100%;
            height: 100vh;
            /* agar main setinggi layar */
            display: flex;
            justify-content: center;
            align-items: center;
        }
            ...
            <div class="left">
                <div class="form">
                    <div class="form-content">
                        <img src="{{ asset('assets/img/logo.png') }}" alt="Logo JMB" class="logo">
                        <h1>Login</h1>
                        <form action="{{ route('proses.login') }}" method="POST" class="form-login">
                            @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            @if ($errors->any())
                Swal.fire({
                    title: 'Kesalahan!',
                    text: 'Login gagal. Email dan Password tidak sesuai',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            @endif
